      ...
      return (
        <>
          <Field label="Start title">
            <input value={data.startTitle} onChange={(event) => patch({ startTitle: event.target.value })} />
          </Field>
      ...
      return (
        <>
          ...
          <Field label="Approver role">
            <select value={data.approverRole} onChange={(event) => patch({ approverRole: event.target.value })}>
      ...
      return (
        <>
          ...
          {selected?.params.map((param) => (
            <Field label={humanize(param)} key={param}>
              <input
      ...
      return (
        <>
          <Field label="End message">
            <textarea value={data.endMessage} onChange={(event) => patch({ endMessage: event.target.value })} />
          </Field>
